module Common.App.Ui.LinkRenderer 
       (
...
import qualified Common.App.Ui.UiResources as UiResources
...
otServiceDisplay enum =
  case enum of
    ...
    ShowMany      -> AnySVALUE $ UnquotedStringValue "Visa lista"
    ShowSelection -> AnySVALUE $ UnquotedStringValue "Visa urval"
